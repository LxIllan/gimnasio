                ...
                <div class="card">
                    <div class="card-primary">
                        <div class="card card-heading">
                            <center><h3 class="card-title">Estadísticas del <?php echo "<b>" . Util::formatearFecha($fechaInicio) . " </b>al<b> " . Util::formatearFecha($fechaFin) . "</b>"; ?></h3></center>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-hover table-sm">
                                        ...
                                        $membresiasDeHoy = $adminSocios->dameVentaDeMembresiasFechas($fechaInicio, $fechaFin);
                                        $dineroAcomulado = 0;
