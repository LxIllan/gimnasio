                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input id="txtNombre" type="text" class="form-control" name="txtNombre"
                                value="<?php echo $socio->getNombrePila(); ?>" required pattern="[a-zA-Z\s]*">
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input id="txtApellido1" type="text" class="form-control" name="txtApellido1"
                               value="<?php echo $socio->getApellido1(); ?>" required pattern="[a-zA-Z\s]*">
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input id="txtApellido2" type="text" class="form-control" name="txtApellido2"
                                value="<?php echo $socio->getApellido2(); ?>" pattern="[a-zA-Z\s]*">
                        </div>
                    </div>
                    <div class="form-row">
