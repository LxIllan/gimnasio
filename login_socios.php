...
<body class="bg-dark">
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        <form method="post" action="validar_sesion_socio.php">
            <?php
            if (isset($_GET['error'])) {
                if ($_GET['error'] == 1) {
                    $error = 'Correo electrónico o código incorrecto';
                } elseif ($_GET['error'] == 2) {
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="codigo" type="number" min="1"
                   placeholder="codigo">
            </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <!-- /Recordar Password -->
            <div class="form-group">
                <input class="form-control btn btn-primary btn-block"  type="submit" value="Iniciar">
            </div>
        </form>
      </div>
    </div>
