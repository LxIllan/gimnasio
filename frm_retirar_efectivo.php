...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Retirar Efectivo</li>
        </ol>
        <!-- /.Breadcrumbs-->
        ...
        $ingresoNeto = $adminDinero->obtenerIngresoNeto($idGimnasio);
        ?>
            ...
            <div class="col-sm-12 col-md-12 col-lg-8 col-xl-6">
                <form action="" class="form-control" method="post">
                    ...
                    <input type="number" class="form-control" name="monto" min="0"
                           max="<?php echo $ingresoNeto; ?>" placeholder="100" required><br>
                    <label class="control-label">Justificación:</label><br>
                    <input type="text" class="form-control" name="justificacion"
                           placeholder="Justificación" required> <br>
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($adminDinero->retirarEfectivo($idGimnasio, $monto, $justificacion)) {
            ?>
            <script type="text/javascript">
                alert("Retiro exítoso.");
