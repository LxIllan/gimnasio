...
<head>
    ...
    <meta name="description" content="Surtir Producto">
...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Surtir Producto</li>
        </ol>
        <!-- /.Breadcrumbs-->
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <form action="" class="form-control" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <label class="control-label" for="txtContenido">Contenido:</label>
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label class="control-label" for="tipoProducto">Tipo:</label>
                            <input type="text" class="form-control" name="tipoProducto" id="tipoProducto"
                                min="1" step="1" value="<?php echo $tipoProducto->getTipoProducto(); ?>" disabled>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="control-label" for="txtPiezasASurtir">Piezas a surtir:</label>
                            <input type="number" class="form-control" name="piezasASurtir"
                                id="txtPiezasASurtir"
    ...
    if (isset($_POST['submit'])) {
        $piezasASurtir = $_REQUEST['piezasASurtir'];
        if ($adminProductos->surtirProducto($idProducto, $piezasASurtir)) {
            ?>
